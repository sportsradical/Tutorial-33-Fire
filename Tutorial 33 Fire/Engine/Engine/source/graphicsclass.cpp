...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/square.txt", "../Engine/data/fire01.tga",
								 "../Engine/data/noise01.tga", "../Engine/data/alpha01.tga");
	if(!result)
	{
